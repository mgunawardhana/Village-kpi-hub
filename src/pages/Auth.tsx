                            ...
                            <div className="space-y-5 animate-in slide-in-from-top-4 fade-in duration-500">
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        ...
                                        required
                                        className="h-12 bg-stone-50 border-stone-200 focus:border-amber-500 focus:ring-amber-500/20 rounded-xl placeholder:text-stone-400 text-stone-800"
                                    />
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <Select value={role} onValueChange={(value: "admin" | "quality_circle_leader") => setRole(value)}>
                                        <SelectTrigger className="h-12 bg-stone-50 border-stone-200 focus:ring-amber-500/20 rounded-xl text-stone-800">
